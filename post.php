...
<div>
    <div class="container m-auto mt-3 row">
        <div class="col-8" style = "background: #dde5f4">
        <?php
        ...
        ?>
            <div class="card mb-3" >
                ...
                <div class="card-body">
                  ...
                  <span class="badge bg-primary ">Posted on <?php echo date('F jS, Y', strtotime($posts['created_at'])) ; ?></span>
                  <span class="badge bg-danger"><?php
                                                    $conn = mysqli_connect('localhost','root','','firstProject');
                                                    echo getCategory($conn, $posts['category_id']);
                                                ?></span>
                  ...
                  <!-- 
                  // <?php
                  // $post_images = getImagesByPost($db, $posts['id']);
                  // $c=1; 
                  ...
                  //       <img src="includes/images/<?=$image['image']?>" class="d-block w-100" alt="...">
                  //     </div> -->
                    <!-- <?php
                  //       $c++;
                  //     }
                 ?> -->
                  ...
                  <img src="https://analyticsinsight.b-cdn.net/wp-content/uploads/2020/06/Python1.png" class="img-fluid mb-2 mt-2" alt="Responsive image">
                  <p class="card-text"><?php echo $posts['content']; ?>
                  </p>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <button type="submit" name="addcomment" class="btn btn-primary">Add Comment</button>
              ...
              <h4>Related Posts</h4>
                ...
                <?php
                $pquery="SELECT * FROM posts WHERE category_id={$posts['category_id']} ORDER BY id DESC";
               ...
               <div class="card mb-3" style="max-width: 700px;">
                                   <div class="row g-0">
                                     <div class="col-md-5" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHYSPZpbkmX6EW2d-F06OZ6xZoVUK6WLQKVw&usqp=CAU');background-size: cover">
                ...
                ?>
                   ...
                   <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-6264179354646954"></script>
               </body>
               </html>